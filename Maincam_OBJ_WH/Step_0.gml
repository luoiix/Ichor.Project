    var target_x = Warmhearted_player;
    var target_y = Warmhearted_player;

if (instance_exists(Warmhearted_player))
{
     target_x = Warmhearted_player.x;
     target_y = Warmhearted_player.y;
}
